...
class Defaults(BaseModel):
    ...
    ports: list = Field(default_factory=lambda: [80, 443], description="Порты для TCP-проверки")
    dns_servers: list = Field(default_factory=lambda: ["1.1.1.1", "8.8.8.8"], description="DNS-серверы")
