...
- отображает ping в реальном времени как фиксированные столбцы (без прокрутки);
...
2. Наблюдайте фиксированные столбцы ping (зелёный/жёлтый/красный).
...
2026-05-10 12:00:01 | 22 ms
2026-05-10 12:00:02 | 27 ms
2026-05-10 12:00:03 | 164 ms
```
